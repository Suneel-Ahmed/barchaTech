          ...
          {sec4?.map((val) => (
            <div key={val.id} className="flex px-3 flex-col gap-[20px]">
              <div className="flex items-center gap-[26px]">
                {val?.icon}
                <h1 className=" text-[clamp(20px,2.55vw,30px)]  leading-[140%]  font-extrabold font-inter uppercase  gradient-text">
                  {val?.title}
                </h1>
              </div>
          ...
          {sec4Right?.map((val) => (
            ...
            >
              <div className="flex items-center max-md:me-auto   md:ms-auto gap-[20px]">
                <div className="md:hidden"> {val?.icon}</div>
                <h1 className=" text-[clamp(20px,2.55vw,30px)] max-lg:text-left text-right   leading-[140%] font-extrabold font-inter uppercase  gradient-text">
                  {val?.title}
                </h1>
                <div className="max-md:hidden"> {val?.icon}</div>
              </div>
