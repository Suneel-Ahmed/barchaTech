...
const AskedQuestion = ({ Questions }) => {
  ...
  return (
    <section className="w-full min-h-screen mt-[10vh]  relative flex flex-col place-content-start place-items-center gap-[5vh] overflow-hidden">
      <p className="w-full  gradient-text text-[clamp(40px,6.2vw,82px)] font-leagueSpartan text-center font-semibold leading-normal">
              ...
              {activeFAQ === idx ? (
                ...
                <>
                  {faq.attributes.answer
                    ...
                    .slice(0, 18)
                    .map((word) => word + " ")}
                  {/* <span className="text-[#BC13FE]">Learn more</span> */}
                </>
              )}
            </p>
            <button
