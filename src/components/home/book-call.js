...
export default function BookCall() {
  return (
    ...
    >
      <p className="mb-4 lg:mb-0 text-transparent text-[clamp(40px,5.5vw,103px)] text-center font-leagueSpartan font-semibold leading-[100%] uppercase bg-clip-text bg-gradient-to-r from-[#FFFFFF] from-[30%] to-[#E33AFF]">
      Schedule Call
      </p>
